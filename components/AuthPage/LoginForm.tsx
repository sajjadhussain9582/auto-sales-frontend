...
export function LoginForm() {
  ...
  return (
    <div className="bg-background relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-4">
      <div
        className="bg-primary/10 pointer-events-none absolute top-0 right-0 size-[min(100vw,500px)] rounded-full blur-[120px]"
        aria-hidden
      />
      <div
        className="bg-primary/5 pointer-events-none absolute bottom-0 left-0 size-[min(100vw,500px)] rounded-full blur-[120px]"
        aria-hidden
      />
